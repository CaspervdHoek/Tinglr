...
public class GetFavoritesTask extends AsyncTask<String, Void, List<Post>> {
	...
	public GetFavoritesTask(Model model, DashboardActivity activity, ListView listview){
		this.model = model;
	...
	protected List<Post> doInBackground(String... params) {
		return client.blogLikes(client.user().getName(), options);
	}
